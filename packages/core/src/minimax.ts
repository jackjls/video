...
/** Default base URL for the mainland China MiniMax API (`minimaxi.com`).
 *  Override via OD_MINIMAX_BASE_URL when using another MiniMax region. */
  ...
  try {
    ...
    throw new HtmlVideoError(
      ...
      isTimeout
        ...
        : `minimax ${label} request failed: ${msg} (check OD_MINIMAX_BASE_URL — default is api.minimaxi.com)`,
      true,
    );
  }
